...
class BuildersControllerTest < ActionController::TestCase
  ...
  test "should create builder" do
    assert_difference('Builder.count') do
      post :create, builder: { email: @builder.email, first_name: @builder.first_name, last_name: @builder.last_name, password: @builder.password }
    end
  ...
  test "should update builder" do
    patch :update, id: @builder, builder: { email: @builder.email, first_name: @builder.first_name, last_name: @builder.last_name, password: @builder.password }
    assert_redirected_to builder_path(assigns(:builder))
  end
